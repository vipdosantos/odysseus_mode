...
export const SCREENS = [
  ...
  { path: '/relatorios-producao', label: 'Relatórios de Produção' },
  ...
  { path: '/estoque-patrimonio', label: 'Estoque & Patrimônio' },
...
const ROLE_DEFAULTS = {
  ...
  operador: {
    ...
    '/relatorios-producao': ACCESS_EDITAR,
    '/scanner': ACCESS_EDITAR,
    '/calendario': ACCESS_VER,
    '/estoque-patrimonio': ACCESS_EDITAR,
